<template>
  <div class="root">
    <div class="app-head">
      <div class="heading">Roles</div>
      <div>
        <q-btn class="btn" color="primary" style="width: 200px">
          <div class="btn-inner">
            <!-- <div>+</div> -->
            <div><img style="margin-top:5px" src="@/assets/Plus.svg" alt="" /> &nbsp;&nbsp;Create Role</div>
          </div>
        </q-btn>
      </div>
    </div>
...
.btn{
  background: #58A65F !important;
border: 1px solid #58A65F !important;
